...
export const formVariants = tv({
  slots: {
    ...
    selectOptions:
      'absolute top-22 px-3 py-3.5 bg-primary-foreground rounded-4xl border border-input w-full grid gap-y-2',
    selectTrigger:
      'flex justify-between items-center px-3 py-3.5 rounded-full border border-input cursor-pointer capitalize',
    option:
